...
# -*- coding: utf-8 -*-
"""
Created on Sat Aug 25 18:26:27 2018
...
dup_tbl[col].to_csv('../data/same_user_all.csv.gz', index=False, compression='gzip')
...
user.to_csv('../data/user_id.csv.gz', index=False, compression='gzip')
