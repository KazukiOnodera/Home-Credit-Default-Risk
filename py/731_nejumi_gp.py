...
def GP1(data):
    ...
    v["i74"] = 0.099260*np.tanh((((((-1.0*(((((data["nejumi"]) > (((np.minimum((((((data["NEW_SOURCES_PROD"]) < (((0.636620) * 2.0)))*1.))), ((0.636620)))) + (np.tanh((0.318310))))))*1.))))) * 2.0)) * 2.0)) 
    v["i75"] = 0.099504*np.tanh((-1.0*((np.where(np.where(data["CLOSED_AMT_CREDIT_SUM_LIMIT_SUM"]<0, data["nejumi"], 0.318310 ) < -99998, 0.318310, np.where(data["NEW_SOURCES_PROD"] < -99998, data["nejumi"], np.where(data["NEW_SOURCES_PROD"]<0, data["NEW_SOURCES_PROD"], data["nejumi"] ) ) ))))) 
    ...
    v["i116"] = 0.099950*np.tanh(np.where(data["nejumi"]<0, np.where(data["NEW_SOURCES_PROD"] < -99998, np.where(((0.636620) + (data["nejumi"]))<0, data["NAME_INCOME_TYPE_Maternity_leave"], data["nejumi"] ), data["nejumi"] ), ((2.0) + (data["nejumi"])) )) 
    ...
    v["i392"] = 0.090389*np.tanh(np.where(data["NEW_SOURCES_PROD"]>0, ((data["nejumi"]) - (data["NEW_SOURCES_PROD"])), (((data["NEW_SOURCES_PROD"]) > (np.tanh((((((data["CLOSED_AMT_CREDIT_SUM_MEAN"]) - (1.0))) - (data["NEW_SOURCES_PROD"]))))))*1.) )) 
    ...
    v["i411"] = 0.097800*np.tanh(np.where(((data["NEW_SOURCES_PROD"]) + (data["nejumi"]))<0, np.where(data["nejumi"] < -99998, 0.0, (((data["DAYS_BIRTH"]) < (np.tanh(((((data["nejumi"]) < (data["NAME_INCOME_TYPE_Student"]))*1.)))))*1.) ), data["AMT_ANNUITY"] )) 
...
def GP2(data):
    ...
    v["i65"] = 0.099910*np.tanh(np.where(((data["NEW_SOURCES_PROD"]) - (np.tanh((((data["nejumi"]) * 2.0)))))>0, -2.0, (-1.0*((np.where(data["NEW_SOURCES_PROD"] < -99998, data["NAME_EDUCATION_TYPE_Academic_degree"], ((((data["NEW_SOURCES_PROD"]) * 2.0)) * 2.0) )))) )) 
    v["i66"] = 0.099640*np.tanh(np.where(data["NEW_SOURCES_PROD"] < -99998, data["NAME_INCOME_TYPE_Maternity_leave"], ((((((((-1.0) - (((data["NEW_SOURCES_PROD"]) * 2.0)))) - (data["nejumi"]))) * 2.0)) - (np.minimum(((data["NEW_SOURCES_PROD"])), ((data["nejumi"]))))) )) 
    ...
    v["i75"] = 0.099510*np.tanh(((np.minimum(((((1.570796) - (np.where(data["BURO_AMT_CREDIT_SUM_DEBT_MEAN"]>0, data["BURO_AMT_CREDIT_SUM_DEBT_MEAN"], data["nejumi"] ))))), ((((np.where(data["BURO_AMT_CREDIT_SUM_DEBT_MEAN"]>0, data["NAME_INCOME_TYPE_Unemployed"], data["nejumi"] )) - (data["NEW_SOURCES_PROD"])))))) * 2.0)) 
    ...
    v["i82"] = 0.099796*np.tanh(np.where(data["nejumi"] < -99998, ((-1.0) / 2.0), ((((((np.minimum(((data["NEW_SOURCES_PROD"])), ((data["NEW_CREDIT_TO_INCOME_RATIO"])))) * (data["nejumi"]))) + (data["NEW_CREDIT_TO_INCOME_RATIO"]))) + (np.tanh((-1.0)))) )) 
    v["i85"] = 0.099980*np.tanh(((((((np.tanh((-1.0))) - (data["NEW_SOURCES_PROD"]))) - (data["CLOSED_AMT_CREDIT_SUM_DEBT_SUM"]))) * (((-2.0) - (((np.where(data["nejumi"] < -99998, -1.0, data["nejumi"] )) * 2.0)))))) 
    ...
    v["i148"] = 0.099000*np.tanh(np.minimum((((((data["NAME_CONTRACT_TYPE_Revolving_loans"]) < (data["nejumi"]))*1.))), ((((((np.where(data["NEW_SOURCES_PROD"]>0, data["NEW_DOC_IND_KURT"], (((((1.0) + (data["NEW_DOC_IND_KURT"]))/2.0)) - (data["nejumi"])) )) * 2.0)) * 2.0))))) 
    ...
    v["i255"] = 0.099548*np.tanh(np.where(data["NEW_SOURCES_PROD"] < -99998, np.where(data["nejumi"] < -99998, data["NEW_SOURCES_PROD"], ((np.tanh((np.tanh((data["nejumi"]))))) - (data["nejumi"])) ), np.minimum(((0.636620)), ((data["nejumi"]))) )) 
    ...
    v["i497"] = 0.099830*np.tanh((((data["OCCUPATION_TYPE_Laborers"]) < (((((np.minimum(((data["NAME_INCOME_TYPE_Student"])), ((((((data["NEW_SOURCES_PROD"]) * 2.0)) - (data["nejumi"])))))) * 2.0)) - (((data["NEW_SOURCES_PROD"]) / 2.0)))))*1.)) 
    v["i499"] = 0.046598*np.tanh(((((((data["nejumi"]) < (np.minimum((((((data["OCCUPATION_TYPE_Laborers"]) < (data["NEW_SOURCES_PROD"]))*1.))), ((data["NEW_SOURCES_PROD"])))))*1.)) + ((-1.0*(((((-2.0) < (np.minimum(((data["nejumi"])), ((data["NEW_SOURCES_PROD"])))))*1.))))))/2.0)) 
    v["i503"] = 0.099960*np.tanh(((np.where((((data["nejumi"]) + ((((0.318310) + (data["APPROVED_AMT_DOWN_PAYMENT_MAX"]))/2.0)))/2.0)<0, 0.0, (-1.0*(((((data["APPROVED_AMT_DOWN_PAYMENT_MAX"]) > (np.maximum(((data["NEW_SOURCES_PROD"])), ((data["NAME_INCOME_TYPE_Student"])))))*1.)))) )) * 2.0)) 
    v["i507"] = 0.099096*np.tanh((((((np.where(data["NEW_SOURCES_PROD"] < -99998, data["AMT_ANNUITY"], data["NEW_SOURCES_PROD"] )) < (data["nejumi"]))*1.)) * (np.where(data["NEW_SOURCES_PROD"]>0, data["AMT_ANNUITY"], np.minimum(((data["nejumi"])), (((-1.0*((data["NEW_SOURCES_PROD"])))))) )))) 
    ...
    v["i509"] = 0.099609*np.tanh((-1.0*(((((data["NEW_SOURCES_PROD"]) > (np.where(data["NEW_ANNUITY_TO_INCOME_RATIO"]<0, (((data["nejumi"]) > (np.tanh((0.636620))))*1.), np.where(np.tanh((data["nejumi"]))<0, 0.318310, data["AMT_ANNUITY"] ) )))*1.))))) 
...
def GP3(data):
    ...
    v["i311"] = 0.091399*np.tanh(((np.where((((data["NEW_SOURCES_PROD"]) + (1.0))/2.0)>0, ((data["nejumi"]) * 2.0), np.minimum((((-1.0*((data["nejumi"]))))), (((((data["nejumi"]) > (data["NEW_SOURCES_PROD"]))*1.)))) )) / 2.0)) 
    v["i312"] = 0.080001*np.tanh(np.where(data["NEW_SOURCES_PROD"]>0, np.minimum(((data["nejumi"])), ((data["AMT_REQ_CREDIT_BUREAU_YEAR"]))), ((0.0) - ((((0.318310) < (np.minimum(((data["AMT_REQ_CREDIT_BUREAU_QRT"])), ((data["nejumi"])))))*1.))) )) 
    ...
    v["i380"] = 0.100000*np.tanh(np.where(data["NEW_SOURCES_PROD"] < -99998, (-1.0*((((1.0) + (data["nejumi"]))))), ((((0.636620) + (((((((0.636620) + (data["NEW_SOURCES_PROD"]))) * 2.0)) * 2.0)))) * 2.0) )) 
