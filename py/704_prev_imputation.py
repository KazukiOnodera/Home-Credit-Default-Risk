...
# -*- coding: utf-8 -*-
"""
Created on Sun Jul 29 01:38:59 2018
...
prev_train = pd.read_feather('../data/prev_train_imputation_f704.f')
prev_test  = pd.read_feather('../data/prev_test_imputation_f704.f')
