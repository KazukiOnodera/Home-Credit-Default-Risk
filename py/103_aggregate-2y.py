...
num_aggregations = {
    ...
    'AMT_ANNUITY-m-app_AMT_CREDIT-dby-app_AMT_INCOME_TOTAL':      ['min', 'mean', 'max'],
    'AMT_APPLICATION-m-app_AMT_CREDIT-dby-app_AMT_INCOME_TOTAL':      ['min', 'mean', 'max'],
    'AMT_CREDIT-m-app_AMT_CREDIT-dby-app_AMT_INCOME_TOTAL':      ['min', 'mean', 'max'],
    'AMT_GOODS_PRICE-m-app_AMT_CREDIT-dby-app_AMT_INCOME_TOTAL':      ['min', 'mean', 'max'],
    ...
    'AMT_ANNUITY-m-app_AMT_ANNUITY-dby-app_AMT_INCOME_TOTAL':      ['min', 'mean', 'max'],
    'AMT_APPLICATION-m-app_AMT_ANNUITY-dby-app_AMT_INCOME_TOTAL':      ['min', 'mean', 'max'],
    'AMT_CREDIT-m-app_AMT_ANNUITY-dby-app_AMT_INCOME_TOTAL':      ['min', 'mean', 'max'],
    'AMT_GOODS_PRICE-m-app_AMT_ANNUITY-dby-app_AMT_INCOME_TOTAL':      ['min', 'mean', 'max'],
    ...
    'AMT_ANNUITY-m-app_AMT_GOODS_PRICE-dby-app_AMT_INCOME_TOTAL':      ['min', 'mean', 'max'],
    'AMT_APPLICATION-m-app_AMT_GOODS_PRICE-dby-app_AMT_INCOME_TOTAL':      ['min', 'mean', 'max'],
    'AMT_CREDIT-m-app_AMT_GOODS_PRICE-dby-app_AMT_INCOME_TOTAL':      ['min', 'mean', 'max'],
    'AMT_GOODS_PRICE-m-app_AMT_GOODS_PRICE-dby-app_AMT_INCOME_TOTAL':      ['min', 'mean', 'max'],    
