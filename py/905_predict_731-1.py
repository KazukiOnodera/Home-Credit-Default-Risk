...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul 31 15:48:17 2018
...
SUBMIT_FILE_PATH = '../output/731-1.csv.gz'

COMMENT = f'CV auc-mean(7-fold):  0.80119 + 0.00294 all({ FEATURE_SIZE })+nejumi'
...
imp = pd.read_csv('LOG/imp_807-1_cv_adversarial_select.py.csv')
imp.sort_values('total', ascending=False, inplace=True)

file_tr = ('../feature/train_' + imp.head(FEATURE_SIZE).feature + '.f').tolist()
file_te = ('../feature/test_'  + imp.head(FEATURE_SIZE).feature + '.f').tolist()
