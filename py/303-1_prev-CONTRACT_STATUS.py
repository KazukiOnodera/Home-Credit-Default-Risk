...
values = prev['NAME_CONTRACT_STATUS'].unique()
for v in values:
    prev_ = prev[prev['NAME_CONTRACT_STATUS']==v]
    PREF = f'prev_{v}'
    # =============================================================================
    # cat
    # =============================================================================
...
utils.to_pickles(train, '../data/303-1_train', utils.SPLIT_SIZE)
utils.to_pickles(test,  '../data/303-1_test',  utils.SPLIT_SIZE)
