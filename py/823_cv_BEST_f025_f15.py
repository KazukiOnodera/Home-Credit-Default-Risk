...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug 28 09:47:39 2018
...
# load
# =============================================================================
X = pd.read_csv('../data/Valid_stochastic_blending_v3-2_valid_0.308rk_0.444mw1_0.248t1_0.81050CV_0.3Adv.csv')
...
for i in range(30,1000,30):
    ...
    CAT = list( set(X_new.columns) & set(utils_cat.ALL) )
