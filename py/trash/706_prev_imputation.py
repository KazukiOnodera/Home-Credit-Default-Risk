...
# -*- coding: utf-8 -*-
"""
Created on Sun Jul 29 01:41:21 2018
...
prev_train = pd.read_feather('../data/prev_train_imputation_f706.f')
prev_test  = pd.read_feather('../data/prev_test_imputation_f706.f')
