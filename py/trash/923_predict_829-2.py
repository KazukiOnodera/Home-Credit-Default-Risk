...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug 29 03:52:56 2018
...
SUBMIT_FILE_PATH = '../output/829-2.csv.gz'


EXE_SUBMIT = False

COMMENT = 'LB804 + last & next TARGET'
...
features = pd.Series(['f025_last_TARGET', 'f025_next_TARGET'])
#==============================================================================
