...
# -*- coding: utf-8 -*-
"""
Created on Sun Aug 26 12:20:28 2018
...
dup = pd.read_csv(f'../data/same_user_all_v{version}.csv.gz')
...
feature = pd.merge(feature, pd.read_csv(f'../data/user_id_v{version}.csv.gz'), on=KEY, how='left')
