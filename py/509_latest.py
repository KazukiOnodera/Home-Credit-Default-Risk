...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul 25 11:44:36 2018
...
# latest
bure = bure.sort_values([KEY, 'DAYS_CREDIT'], ascending=[True, False]).drop_duplicates(KEY, keep='first').reset_index(drop=True)
...
['f509_CREDIT_ACTIVE', 'f509_CREDIT_CURRENCY', 'f509_CREDIT_TYPE']
