...
# -*- coding: utf-8 -*-
"""
Created on Sun Jul 29 00:00:13 2018
...
val = utils.read_pickles('../data/prev_train', ['active'])
tr_ind = val[val['active']==1].index

val = utils.read_pickles('../data/prev_test', ['active'])
te_ind = val[val['active']==1].index
...
sub_train.to_feather('../data/prev_train_imputation_f705.f')
sub_test.to_feather('../data/prev_test_imputation_f705.f')
