...
# -*- coding: utf-8 -*-
"""
Created on Sun Jul 29 00:38:39 2018
...
val = utils.read_pickles('../data/prev_test', ['NAME_CONTRACT_STATUS'])
te_ind = val[val['NAME_CONTRACT_STATUS']=='Approved'].index
...
sub_train.to_feather('../data/prev_train_imputation_f706.f')
sub_test.to_feather('../data/prev_test_imputation_f706.f')
